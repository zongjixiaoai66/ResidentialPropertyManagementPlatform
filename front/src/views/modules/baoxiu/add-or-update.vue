    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yuangong' && sessionTable !='yonghu'">
                ...
                <el-col :span="24" v-if="sessionTable !='yuangong' && sessionTable !='yonghu'">
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.baoxiuPhoto" label="报修图片" prop="baoxiuPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.baoxiuPhoto?ruleForm.baoxiuPhoto:''"
                            @change="baoxiuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.baoxiuPhoto" label="报修图片" prop="baoxiuPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.baoxiuPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="报修类型" prop="baoxiuTypes">
                        <el-select v-model="ruleForm.baoxiuTypes" placeholder="请选择报修类型">
                            <el-option
                ...
                <el-col :span="12" v-if="id != '' && id != null">
                    <el-form-item class="select" v-if="type!='info'"  label="是否维修" prop="baoxiuWeixiuTypes">
                        <el-select v-model="ruleForm.baoxiuWeixiuTypes" placeholder="请选择是否维修">
                            <el-option
                                v-for="(item,index) in baoxiuWeixiuTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否维修" prop="baoxiuWeixiuValue">
                        <el-input v-model="ruleForm.baoxiuWeixiuValue"
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=baoxiu_weixiu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.baoxiuWeixiuTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='baoxiuName'){
                          this.ruleForm.baoxiuName = obj[o];
                          this.ro.baoxiuName = true;
                          continue;
                      }
                      if(o=='baoxiuPhoto'){
                          this.ruleForm.baoxiuPhoto = obj[o];
                          this.ro.baoxiuPhoto = true;
                          continue;
                      }
                      if(o=='baoxiuTypes'){
                          this.ruleForm.baoxiuTypes = obj[o];
                      ...
                      if(o=='baoxiuContent'){
                          this.ruleForm.baoxiuContent = obj[o];
                          this.ro.baoxiuContent = true;
                          continue;
                      }
                      if(o=='baoxiuWeixiuTypes'){
                          this.ruleForm.baoxiuWeixiuTypes = obj[o];
                          this.ro.baoxiuWeixiuTypes = true;
                          continue;
                      }
                    }
                }

               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="通知类型" prop="tongzhiTypes">
                        <el-select v-model="ruleForm.tongzhiTypes" placeholder="请选择通知类型">
                            <el-option
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='tongzhiName'){
                          this.ruleForm.tongzhiName = obj[o];
                          this.ro.tongzhiName = true;
                          continue;
                      }
                      if(o=='tongzhiPhoto'){
                          this.ruleForm.tongzhiPhoto = obj[o];
                          this.ro.tongzhiPhoto = true;
                          continue;
                      }
                      if(o=='tongzhiTypes'){
                          this.ruleForm.tongzhiTypes = obj[o];
                          this.ro.tongzhiTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
                      ...
                      if(o=='tongzhiContent'){
                          this.ruleForm.tongzhiContent = obj[o];
                          this.ro.tongzhiContent = true;
                          continue;
                      }
                    }
                }

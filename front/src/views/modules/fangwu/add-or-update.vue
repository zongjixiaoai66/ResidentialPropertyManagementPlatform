               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="房屋类型" prop="fangwuTypes">
                        <el-select v-model="ruleForm.fangwuTypes" placeholder="请选择房屋类型">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="房屋详情" prop="fangwuContent">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='fangwuName'){
                          this.ruleForm.fangwuName = obj[o];
                          this.ro.fangwuName = true;
                          continue;
                      }
                      if(o=='fangwuAddress'){
                          this.ruleForm.fangwuAddress = obj[o];
                          this.ro.fangwuAddress = true;
                          continue;
                      }
                      if(o=='fangwuPhoto'){
                          this.ruleForm.fangwuPhoto = obj[o];
                          this.ro.fangwuPhoto = true;
                          continue;
                      }
                      if(o=='fangwuTypes'){
                          this.ruleForm.fangwuTypes = obj[o];
                          this.ro.fangwuTypes = true;
                          continue;
                      }
                      if(o=='fangwuDelete'){
                          this.ruleForm.fangwuDelete = obj[o];
                          this.ro.fangwuDelete = true;
                          continue;
                      }
                      if(o=='fangwuContent'){
                          this.ruleForm.fangwuContent = obj[o];
                          this.ro.fangwuContent = true;
                          continue;
                      }
                    }
                }

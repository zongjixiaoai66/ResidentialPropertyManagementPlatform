<template>
  <div>
    ...
    >  
     <el-row>
                                     <el-col :span="12">
                              <el-form-item v-if="flag=='yonghu'"  label='住户姓名' prop="yonghuName">
                                  <el-input v-model="ruleForm.yonghuName"  placeholder='住户姓名' clearable></el-input>
                              </el-form-item>
                          </el-col>

                          <el-col :span="12">
                              <el-form-item v-if="flag=='yonghu'"  label='住户手机号' prop="yonghuPhone">
                                  <el-input v-model="ruleForm.yonghuPhone"  placeholder='住户手机号' clearable></el-input>
                              </el-form-item>
                          </el-col>

                          <el-col :span="12">
                              <el-form-item v-if="flag=='yonghu'"  label='住户身份证号' prop="yonghuIdNumber">
                                  <el-input v-model="ruleForm.yonghuIdNumber"  placeholder='住户身份证号' clearable></el-input>
                              </el-form-item>
                          </el-col>

                        <el-col :span="24">
                            <el-form-item v-if="flag=='yonghu'" label='住户照片' prop="yonghuPhoto">
                                <file-upload
                                        tip="点击上传照片"
                                        action="file/upload"
                                        :limit="3"
